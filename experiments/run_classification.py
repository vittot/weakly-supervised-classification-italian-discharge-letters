...
from classification import run_full_experiment_resumable, setup_dataset
...
dataset, df_bal = setup_dataset(df, text_col=text_col, gold_label_col=gold_label_col, weak_label_col=weak_label_col)
